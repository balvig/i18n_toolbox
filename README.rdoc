...
=== truncate
  ...
  **Output:**
  I18n.locale = :en
  truncate("2 byte characters are wider", :length => 20, :localize => true) # => "2 byte characters..."
  I18n.locale = :ja
  truncate("2 byte characters are wider", :length => 20, :localize => true) # => "2 byte ..."
...
=== validates_length_of
  ...
  **Model:**
  ...
  I18n.locale = :en
  Post.new(:title => 'English sentences use more chars').valid? # => true
  I18n.locale = :ja
  Post.new(:title => 'Japanese sentences use fewer chars').valid? # => false
